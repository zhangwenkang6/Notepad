        ...
        + '<div class="notepad-dlg-mask notepad-dlg-about">'
          + '<div class="dialogbox notepad-dlgbox">'
            ...
            + '<div class="main notepad-dlg-main">'
              ...
              + '<hr>'
              + '<img class="app-logo" src="//zhangwenkang6.github.io/Notepad/images/notepad-icon-32.png" alt="JSNotepad">'
  <!-- build:css bundle.min.css -->
              + '<div class="info">'
                + '<p>作者：张文康</p>'
                + '<p>QQ：823809867</p>'
                + '<p>仓库地址：<a href="https://github.com/zhangwenkang6/Notepad/" target="_blank">https://github.com/zhangwenkang6/Notepad/</a></p>'
              + '</div>'
